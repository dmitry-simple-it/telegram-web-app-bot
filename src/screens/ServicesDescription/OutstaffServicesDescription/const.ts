...
export const outstaffMessages: MessageRecordsType = [
  ...
  {
    text: 'Профессиональный разработчик (middle или senior) сразу погружается в Ваш проект. Ставка фикс (р/час). Расчет в конце периода за отработанные часы.',
  },
  {
    text: 'Наш разработчик - Ваш разработчик! Нужен Outstaff? - Просто нажмите кнопку ниже',
